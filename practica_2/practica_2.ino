...
void loop()
{
  ...
  analogWrite(led0, 42);    // posar PWM del pin 3 a 125
  
  delay(velocitat);           // es queden leds velocitat ms en aquest estat
  
  analogWrite(led0, 84);    // posar PWM del pin 3 a 255
  analogWrite(led1, 42);    // posar PWM del pin 5 a 255
   
  delay(velocitat);           // es queden leds velocitat ms en aquest estat
  
  analogWrite(led0, 125);    // posar PWM del pin 3 a 125
  analogWrite(led1, 84);    // posar PWM del pin 5 a 125
  analogWrite(led2, 42);    // posar PWM del pin 6 a 125
  
  delay(velocitat);           // es queden leds velocitat ms en aquest estat
   
  analogWrite(led0, 168);     // posar PWM del pin 3 a 60
  analogWrite(led1, 125);     // posar PWM del pin 5 a 60
  analogWrite(led2, 84);     // posar PWM del pin 6 a 60
  analogWrite(led3, 42);     // posar PWM del pin 9 a 60
  
  delay(velocitat);          // es queden leds velocitat ms en aquest estat 
  
  analogWrite(led0, 210);     // posar PWM del pin 3 a 60
  analogWrite(led1, 168);     // posar PWM del pin 5 a 60
  analogWrite(led2, 125);     // posar PWM del pin 6 a 60
  analogWrite(led3, 84);     // posar PWM del pin 9 a 60
  analogWrite(led4, 42);     // posar PWM del pin 10 a 60

  delay(velocitat);          // es queden leds velocitat ms en aquest estat
   
  analogWrite(led0, 255);     // posar PWM del pin 3 a 60
  analogWrite(led1, 210);     // posar PWM del pin 5 a 60
  analogWrite(led2, 168);     // posar PWM del pin 6 a 60
  analogWrite(led3, 125);     // posar PWM del pin 9 a 60
  analogWrite(led4, 84);     // posar PWM del pin 10 a 60
  analogWrite(led5, 42);     // posar PWM del pin 11 a 60
  
  delay(velocitat);          // es queden leds velocitat ms en aquest estat
   
  analogWrite(led0, 255);     // posar PWM del pin 3 a 60
  analogWrite(led1, 255);     // posar PWM del pin 5 a 60
  analogWrite(led2, 210);     // posar PWM del pin 6 a 60
  analogWrite(led3, 168);     // posar PWM del pin 9 a 60
  analogWrite(led4, 125);     // posar PWM del pin 10 a 60
  analogWrite(led5, 84);     // posar PWM del pin 11 a 60
  ...
  analogWrite(led3, 210);     // posar PWM del pin 9 a 60
  analogWrite(led4, 168);     // posar PWM del pin 10 a 60
  ...
  analogWrite(led4, 210);     // posar PWM del pin 10 a 60
  analogWrite(led5, 168);     // posar PWM del pin 11 a 60
  ...
  analogWrite(led5, 210);     // posar PWM del pin 11 a 60
